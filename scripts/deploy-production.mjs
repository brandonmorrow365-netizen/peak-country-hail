...
const deploy={...generated,name:production.name,workers_dev:production.workers_dev,preview_urls:production.preview_urls,routes:production.routes,vars:production.vars,triggers:production.triggers,observability:production.observability,send_email:production.send_email};
