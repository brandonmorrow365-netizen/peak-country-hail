...
export const contentMeta: ContentMeta[] = [
  ...
  { path: '/auto-hail-repair/', lastmod: '2026-09-24' },
  { path: '/contact/', lastmod: '2026-09-06' },
  { path: '/data-sources/', lastmod: '2026-09-24', feed: { title: 'Hail Data Sources and Methodology', description: 'How Peak Country uses and labels NWS, SPC, and NOAA/NCEI hail information.', published: '2026-09-05' } },
  { path: '/door-ding-repair/', lastmod: '2026-09-08' },
  { path: '/estimating-documentation/', lastmod: '2026-09-24' },
  { path: '/faq/', lastmod: '2026-09-24' },
  { path: '/free-hail-inspection/', lastmod: '2026-09-24' },
  { path: '/get-started/', lastmod: '2026-09-24' },
  { path: '/gallery/', lastmod: '2026-09-09' },
  { path: '/hail-damage-guide/', lastmod: '2026-09-24' },
  ...
  { path: '/hail-status-widget/', lastmod: '2026-09-24' },
  { path: '/hail-tracker/', lastmod: '2026-09-24' },
  ...
  { path: '/insurance-claims/', lastmod: '2026-09-24' },
  { path: '/northern-colorado-hail-history/', lastmod: '2026-09-24', feed: { title: 'Northern Colorado Hail History: 2022–2026', description: 'A verified five-calendar-year NOAA/NCEI history window within 50 miles of Greeley.', published: '2026-09-05' } },
  { path: '/paintless-dent-repair/', lastmod: '2026-09-09' },
  { path: '/process/', lastmod: '2026-09-08' },
  { path: '/repair-standards/', lastmod: '2026-09-08' },
  { path: '/resources/', lastmod: '2026-09-24' },
  { path: '/service-area/', lastmod: '2026-09-24' },
  { path: '/warranty/', lastmod: '2026-09-24' },
  { path: '/why-pdr/', lastmod: '2026-09-24' },
];
